...
میتونید یک یا چند NAT64 Prefix [از اینجا](https://github.com/Starry-Sky-World/BPB-i18n/blob/main/docs/NAT64Prefixes.md) انتخاب کنید که IPها رو بر اساس منطقه و ISP لیست کرده.
