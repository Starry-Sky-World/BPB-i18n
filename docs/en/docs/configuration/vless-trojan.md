...
You can find available NAT64 Prefixes [in here](https://github.com/Starry-Sky-World/BPB-i18n/blob/main/docs/NAT64Prefixes.md), which lists IPs by region and ISP.
